...
import OrgCentro from '../../assets/img/logos/orgcentro.png'
import TpcSeguros from '../../assets/img/logos/tpcseguros.png'
import Prof from '../../assets/img/logos/prof.png'
import Corredores from '../../assets/img/logos/corredores.png'
            ...
            <div id='lema' >
                ...
                <div className="slider">
                        ...
                        <ul className="marcas">
                            ...
                            <li className="marcas-logo" > <img src={OrgCentro}  alt="" /> </li>
                            <li className="marcas-logo" > <img src={TpcSeguros}  alt="" /> </li>
                            <li className="marcas-logo" > <img src={Prof}  alt="" /> </li>
                            <li className="marcas-logo" > <img src={Corredores}  alt="" /> </li>
